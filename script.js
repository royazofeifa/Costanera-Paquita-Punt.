...
function iniciarConfirmacion(parametros) {
  ...
  valido = valido && ["fecha", "orador", "congregacion", "tema"].every((id) => datos[id]) && fechaValida(datos.fecha) && numeroOpcionalValido(datos.bosquejo) && numeroOpcionalValido(datos.cancion);
  if (!valido) {
